  ...
  <div>
    ...
    <van-swipe :autoplay="3000" :show-indicators="true" @change="onChange" class="banner">
        ...
        <div class="custom-indicator" slot="indicator">
            <!-- {{ current }} -->
        <div class="banner_info" v-for="(item,i) of bannerList" :key="i">
...
export default {
    ...
    methods: {
        ...
        onLoad () {
            // console.log('可以加载数据了')
            this.loading = true
            const moreNewsData = { modeType: 1, nodeId: 370, start: this.pageNum, cv: 400, debug: 1 };
            const moreoptions = {
                method: 'POST',
    ...
    mounted () {
        function getBannerData() {
            return   axios({
                        ...
                        data: qs.stringify({ modeType: 1, nodeId: 370, cv: 400, debug: 1 }),
                    })
        }
